  ...
  return (
    <nav className="flex items-center gap-1 overflow-x-auto px-1 py-1 sm:flex-col sm:items-stretch sm:gap-0.5 sm:overflow-visible sm:px-0">
      ...
      <button
        ...
        className="ml-auto whitespace-nowrap rounded-lg px-3 py-2 text-left text-sm font-medium text-slate-500 hover:bg-slate-100 disabled:opacity-60 sm:ml-0 sm:mt-4"
      >
